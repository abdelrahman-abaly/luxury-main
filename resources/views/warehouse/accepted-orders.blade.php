...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0 dashboard-header">Accepted Orders</h2>
        ...
        <div class="row align-items-center">
            <div class="col-md-4">
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="Search accepted orders..." id="searchBox">
            ...
            <div class="col-md-3">
                <select class="form-select" id="bulkAction">
                    ...
                    <option value="send_to_waiting">Send Selected to Waiting Orders</option>
...
<div class="card" id="listView">
    <div class="card-header">
        <h5 class="mb-0">Accepted Orders Ready for Processing</h5>
    </div>
...
<div class="card d-none" id="gridView">
    <div class="card-header">
        <h5 class="mb-0">Grid View - Accepted Orders</h5>
    </div>
    <div class="card-body">
        <div class="row">
            @forelse($orders as $order)
                ...
                <div class="card grid-item">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <form method="POST" action="{{ route('warehouse.ready-for-delivery', $order->id) }}" class="d-inline">
                                @csrf
                                <button type="submit" class="btn btn-primary btn-sm">Ready for Delivery</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    // Send to Waiting Orders functionality
    document.querySelectorAll('.btn-warning').forEach(button => {
        if (button.textContent.includes('Send to Waiting')) {
            button.addEventListener('click', function() {
                if (confirm('Are you sure you want to send this order to Waiting Orders?')) {
                    alert('Order has been sent to Waiting Orders successfully!');
